...
it('can create customer already created exception', function () {
    $owner = new class {
...
it('can create invalid customer exception', function () {
    $owner = new class {};
...
it('can create invalid payment method exception for invalid owner', function () {
    $owner = new class {};
...
it('can create invalid payment method exception for not found', function () {
...
it('can create incomplete payment exception for redirect', function () {
    $payment = new Payment([
        'id' => 'test-id',
        'status' => 'pending',
...
it('can create incomplete payment exception for failed', function () {
    $payment = new Payment([
        'id' => 'test-id',
        'status' => 'failed',
    ]);
...
it('can create incomplete payment exception for expired', function () {
    $payment = new Payment([
        'id' => 'test-id',
        'status' => 'expired',
    ]);
...
it('can create subscription update failure for incomplete subscription', function () {
...
it('can create subscription update failure for duplicate price', function () {
    $subscription = new Subscription([
        'type' => 'default',
    ]);
...
it('can create subscription update failure for deleting last price', function () {
    $subscription = new Subscription([
        'type' => 'default',
    ]);
