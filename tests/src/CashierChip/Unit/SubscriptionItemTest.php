...
it('can increment quantity by specific amount', function () {
...
it('can decrement quantity by specific amount', function () {
...
it('cannot decrement quantity below 1', function () {
...
it('updates subscription quantity for single price', function () {
...
it('can swap to new price', function () {
    $this->item->swap('price_yearly');
    
    expect($this->item->chip_price)->toBe('price_yearly');
});

it('can swap to new price with options', function () {
    $this->item->swap('price_yearly', [
        'product' => 'prod_456',
        'unit_amount' => 99900,
    ]);
...
it('updates subscription price for single price swap', function () {
    $this->item->swap('price_yearly');
...
it('guards against incomplete subscription updates', function () {
    $this->subscription->update([
