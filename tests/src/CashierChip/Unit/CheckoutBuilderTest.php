...
it('can create checkout builder without owner', function () {
    $builder = new CheckoutBuilder();
    
    expect($builder)->toBeInstanceOf(CheckoutBuilder::class);
});

it('can create checkout builder with owner', function () {
    $builder = new CheckoutBuilder($this->owner);
    
    expect($builder)->toBeInstanceOf(CheckoutBuilder::class);
});

it('can set recurring', function () {
    $builder = new CheckoutBuilder($this->owner);
...
it('can set success url', function () {
    $builder = new CheckoutBuilder($this->owner);
...
it('can set cancel url', function () {
    $builder = new CheckoutBuilder($this->owner);
...
it('can set webhook url', function () {
    $builder = new CheckoutBuilder($this->owner);
...
it('can set multiple products', function () {
    $builder = new CheckoutBuilder($this->owner);
