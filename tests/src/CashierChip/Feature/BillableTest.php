...
it('can check if user has chip id', function () {
...
it('can get chip id', function () {
    $this->user->update(['chip_id' => 'test-chip-id']);
    
    expect($this->user->chipId())->toBe('test-chip-id');
});

it('can check if has default payment method', function () {
...
it('can get default payment method', function () {
...
it('can update default payment method', function () {
...
it('can start a new subscription', function () {
...
it('can check if subscribed', function () {
...
it('can check if subscribed to specific price', function () {
    $this->user->subscriptions()->create([
        'type' => 'default',
        'chip_id' => 'test-sub-id',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can get specific subscription', function () {
    $this->user->subscriptions()->create([
        'type' => 'default',
        'chip_id' => 'test-sub-id',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can have multiple subscriptions', function () {
    $this->user->subscriptions()->create([
        'type' => 'default',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can check generic trial on model', function () {
...
it('can get only active subscriptions', function () {
    $this->user->subscriptions()->create([
        'type' => 'active',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can get only canceled subscriptions', function () {
    $this->user->subscriptions()->create([
        'type' => 'active',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can get only recurring subscriptions', function () {
    $this->user->subscriptions()->create([
        'type' => 'recurring',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can get subscriptions on trial', function () {
    $this->user->subscriptions()->create([
        'type' => 'active',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can get subscriptions on grace period', function () {
    $this->user->subscriptions()->create([
        'type' => 'active',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
...
it('can get ended subscriptions', function () {
    $this->user->subscriptions()->create([
        'type' => 'active',
        'chip_id' => 'test-sub-1',
        'chip_status' => Subscription::STATUS_ACTIVE,
