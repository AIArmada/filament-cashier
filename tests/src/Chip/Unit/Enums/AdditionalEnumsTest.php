...
describe('RecurringInterval enum', function () {
    ...
    it('converts to days correctly', function () {
...
describe('RecurringStatus enum', function () {
    it('has correct values', function () {
    ...
    it('correctly checks isActive', function () {
    ...
    it('correctly checks isFinal', function () {
...
describe('ChargeStatus enum', function () {
    it('has correct values', function () {
...
describe('WebhookEventType enum', function () {
    it('has correct purchase lifecycle values', function () {
    ...
    it('has correct payout values', function () {
    ...
    it('correctly identifies purchase events', function () {
    ...
    it('correctly identifies billing events', function () {
    ...
    it('correctly identifies payment events', function () {
    ...
    it('returns correct event class names', function () {
