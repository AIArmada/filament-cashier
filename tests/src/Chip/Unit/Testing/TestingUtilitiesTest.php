...
describe('WebhookFactory', function () {
    ...
    it('creates purchase.created payload', function () {
    ...
    it('creates purchase.payment_failure payload', function () {
    ...
    it('creates purchase.cancelled payload', function () {
    ...
    it('creates purchase.preauthorized payload', function () {
    ...
    it('creates purchase.hold payload', function () {
    ...
    it('creates purchase.captured payload', function () {
    ...
    it('creates purchase.released payload', function () {
    ...
    it('creates purchase.subscription_charge_failure payload', function () {
    ...
    it('creates payment.refunded payload', function () {
    ...
    it('creates billing_template_client.subscription_billing_cancelled payload', function () {
    ...
    it('creates payout.pending payload', function () {
    ...
    it('creates payout.success payload', function () {
    ...
    it('creates payout.failed payload', function () {
    ...
    it('sets amount correctly', function () {
    ...
    it('sets payment method via fpx helper', function () {
    ...
    it('sets payment method via card helper', function () {
    ...
    it('sets payment method via ewallet helper', function () {
    ...
    it('supports overrides via with method', function () {
        $payload = WebhookFactory::purchasePaid([
            'id' => 'custom-id-123',
    ...
    it('sets products array', function () {
    ...
    it('creates expired status', function () {
    ...
    it('creates refunded status', function () {
    ...
    it('includes payment data for paid status', function () {
        $payload = WebhookFactory::purchasePaid();
    ...
    it('excludes payment data for non-paid status', function () {
        $payload = WebhookFactory::purchaseCreated();

        expect($payload['payment'])->toBeNull();
    });

    it('builds status history', function () {
        $payload = WebhookFactory::purchasePaid();
