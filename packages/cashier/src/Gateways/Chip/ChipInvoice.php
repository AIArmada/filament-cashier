...
class ChipInvoice implements InvoiceContract
{
    ...
    {
        return number_format($this->rawSubtotal() / 100, 2).' '.strtoupper($this->currency());
    }
    ...
    {
        return number_format($this->rawTax() / 100, 2).' '.strtoupper($this->currency());
    }
    ...
    {
        return strtoupper($this->purchase->purchase['currency'] ?? 'MYR');
    }
