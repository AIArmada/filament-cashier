...
ISO-4217 currency code used for displaying monetary values in widgets. Individual voucher records still store their configured currency.
...
```env
# No built-in environment overrides
# Use config publishing for customization
```
